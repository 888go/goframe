...
// 如果 `name` 已经被使用，它将返回一个错误。 md5:0f46b08a5a96144a
...
// 如果 `name` 已经被使用，它将返回错误。 md5:96268d3e8373359e
...
// 如果`name`已存在，它将返回一个错误。 md5:9701998ce952852d
...
// 如果`name`已经存在，它将返回一个错误。 md5:505a2bbf10529705
...
// 这个定时任务只能运行一次。 md5:56e7e748e4d4c63d
...
// 如果未找到，返回nil。 md5:06da84fc0766d888
