...
func Test_Format(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		timeTemp, err := gtime.X转换文本("2006-01-11 15:04:05", "Y-m-d H:i:s")
		...
		//补零
		timeTemp1, err := gtime.X转换文本("2006-01-02 03:04:05", "Y-m-d H:i:s")
		if err != nil {
			t.Error("test fail")
		}
		t.Assert(timeTemp1.X取格式文本("Y-m-d h:i:s"), "2006-01-02 03:04:05")
		//不补零
		timeTemp2, err := gtime.X转换文本("2006-01-02 03:04:05", "Y-m-d H:i:s")
		if err != nil {
			t.Error("test fail")
		}
...
func Test_Format_ZeroString(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		timeTemp, err := gtime.X转换文本("0000-00-00 00:00:00")
		t.AssertNE(err, nil)
