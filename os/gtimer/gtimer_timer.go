...
// 参见AddEntry。 md5:6f230211b81dca10
...
// 另请参阅AddSingleton。 md5:4df66d0755ab0371
...
// 参见 AddOnce。 md5:613532ca791628bf
...
// 参阅 AddTimes。 md5:8a53452ea0989047
...
func (t *Timer) createEntry(in createEntryInput) *Entry {
	...
	if intervalTicksOfJob == 0 {
		// 如果给定的间隔小于车轮的间隔，那么将其设置为一个刻度，这意味着它将在一个间隔内运行。 md5:4f1ce7e56c107c6e
		intervalTicksOfJob = 1
	}
	if t.options.Quick {
		// 如果启用了快速模式，意味着它将立即执行。
		// 无需等待第一个时间间隔。 md5:6d9ecc987797b1ba
