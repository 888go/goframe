...
type Field struct {
	...
	// 获取标签值。
	// 字段中可能有多个标签，但根据调用函数的规则，只能获取一个。 md5:45a4365044272532
	TagValue string
}
...
type FieldsInput struct {
	...
	// TODO 这个属性名称不合适，可能会引起混淆。 md5:7115141b84d46b4a
	Pointer interface{}

	// RecursiveOption 定义了如果属性是一个嵌入的结构体，如何递归地检索字段。默认情况下为 RecursiveOptionNone。 md5:ad0b9ef1d1f1f1e5
...
type FieldMapInput struct {
	...
	// 如果传入 `nil`，则返回 map[name]Field，其中 `name` 是属性名称。 md5:454af14097a1e0a3
...
// 参数 `object` 应为结构体类型、指向结构体的指针类型、结构体切片类型或指向结构体的切片类型。 md5:023b27218d435b61
