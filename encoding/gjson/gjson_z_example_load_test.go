...
func ExampleLoad() {
	jsonFilePath := 单元测试类.DataPath("json", "data1.json")
	j, _ := json类.X加载文件(jsonFilePath)
	fmt.Println(j.X取值("name"))
	fmt.Println(j.X取值("score"))

	notExistFilePath := 单元测试类.DataPath("json", "data2.json")
...
func ExampleLoad_Xml() {
	jsonFilePath := 单元测试类.DataPath("xml", "data1.xml")
	j, _ := json类.X加载文件(jsonFilePath)
...
func ExampleLoad_Properties() {
	jsonFilePath := 单元测试类.DataPath("properties", "data1.properties")
	j, _ := json类.X加载文件(jsonFilePath)
