...
func ExampleVar_IsNil() {
	g.X调试输出(泛型类.X创建(0).X是否为Nil())
	g.X调试输出(泛型类.X创建(0.1).X是否为Nil())
	// true
	g.X调试输出(泛型类.X创建(nil).X是否为Nil())
	g.X调试输出(泛型类.X创建("").X是否为Nil())
...
func ExampleVar_IsEmpty() {
	g.X调试输出(泛型类.X创建(0).X是否为空())
	g.X调试输出(泛型类.X创建(nil).X是否为空())
	g.X调试输出(泛型类.X创建("").X是否为空())
	g.X调试输出(泛型类.X创建(g.Map{"k": "v"}).X是否为空())
...
func ExampleVar_IsInt() {
	g.X调试输出(泛型类.X创建(0).X是否为整数())
	g.X调试输出(泛型类.X创建(0.1).X是否为整数())
	g.X调试输出(泛型类.X创建(nil).X是否为整数())
	g.X调试输出(泛型类.X创建("").X是否为整数())
...
func ExampleVar_IsUint() {
	g.X调试输出(泛型类.X创建(0).X是否为正整数())
	g.X调试输出(泛型类.X创建(uint8(8)).X是否为正整数())
	g.X调试输出(泛型类.X创建(nil).X是否为正整数())
...
func ExampleVar_IsSlice() {
	g.X调试输出(g.X泛型类(0).X是否为数组())
	g.X调试输出(g.X泛型类(g.Slice别名{0}).X是否为数组())
...
func ExampleVar_Maps() {
	var m = 泛型类.X创建(g.MapIntInt数组{g.MapIntInt{0: 100, 1: 200}, g.MapIntInt{0: 300, 1: 400}})
