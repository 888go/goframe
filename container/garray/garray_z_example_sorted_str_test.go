...
func ExampleNewStrArrayFromCopy() {
	s := 数组类.X创建文本排序并从数组复制(g.SliceStr别名{"b", "d", "c", "a"})
	fmt.Println(s.X取切片())
...
func ExampleSortedStrArray_At() {
	s := 数组类.X创建文本排序并从数组(g.SliceStr别名{"b", "d", "c", "a"})
	sAt := s.X取值(2)
	fmt.Println(s)
	fmt.Println(sAt)
...
func ExampleSortedStrArray_Get() {
	s := 数组类.X创建文本排序并从数组(g.SliceStr别名{"b", "d", "c", "a", "e"})
	sGet, sBool := s.X取值2(3)
	fmt.Println(s)
...
func ExampleSortedStrArray_PopRights() {
	s := 数组类.X创建文本排序()
	s.X设置数组(g.SliceStr别名{"c", "b", "a", "d", "f", "e", "h", "g"})
	r := s.X出栈右多个(2)
	fmt.Println(r)
	fmt.Println(s)
...
func ExampleSortedStrArray_Merge() {
	s1 := 数组类.X创建文本排序()
	s2 := 数组类.X创建文本排序()
	s1.X设置数组(g.SliceStr别名{"b", "c", "a"})
	s2.X设置数组(g.SliceStr别名{"e", "d", "f"})
	fmt.Println(s1)
	fmt.Println(s2)
	s1.X合并(s2)
	fmt.Println(s1)
...
func ExampleSortedStrArray_Chunk() {
	s := 数组类.X创建文本排序并从数组(g.SliceStr别名{"c", "b", "a", "d", "f", "e", "h", "g"})
	r := s.X分割(3)
	fmt.Println(r)
...
func ExampleSortedStrArray_CountValues() {
	s := 数组类.X创建文本排序并从数组(g.SliceStr别名{"a", "b", "c", "c", "c", "d", "d"})
	fmt.Println(s.X统计())
...
func ExampleSortedStrArray_Filter() {
	s := 数组类.X创建文本排序并从数组(g.SliceStr别名{"b", "a", "", "c", "", "", "d"})
	fmt.Println(s)
