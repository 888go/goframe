...
func Test_IntArray_Basic(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		expect := []int{0, 1, 2, 3}
		expect2 := []int{}
		array := 数组类.X创建整数并从数组(expect)
		array2 := 数组类.X创建整数并从数组(expect2)
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建整数并从数组([]int{0, 1, 2, 3})
		copyArray := array.DeepCopy().(*数组类.IntArray)
		copyArray.X设置值(0, 1)
...
func TestIntArray_PopLeftsAndPopRights(t *testing.T) {
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		...
		array1 := 数组类.X创建整数并从数组(value1)
		array2 := 数组类.X创建整数并从数组(value2)
...
func TestIntArray_Range(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		value1 := []int{0, 1, 2, 3, 4, 5, 6}
		array1 := 数组类.X创建整数并从数组(value1)
		array2 := 数组类.X创建整数并从数组(value1, true)
...
func TestIntArray_Merge(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		...
		a5 := 数组类.X创建文本排序并从数组(s2)
		a6 := 数组类.X创建整数排序并从数组([]int{1, 2, 3})

		a7 := 数组类.X创建文本排序并从数组(s1)
		a8 := 数组类.X创建排序并从数组([]interface{}{4, 5}, func1)
...
func TestIntArray_Fill(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		a1 := []int{0}
		a2 := []int{0}
		array1 := 数组类.X创建整数并从数组(a1)
		array2 := 数组类.X创建整数并从数组(a2)
...
func TestIntArray_PopLeft(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建整数并从数组(g.SliceInt别名{1, 2, 3})
		v, ok := array.X出栈左()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestIntArray_Filter(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建整数并从数组(g.SliceInt别名{0, 1, 2, 3, 4, 0})
		t.Assert(array.X遍历删除(func(index int, value int) bool {
			return empty.IsEmpty(value)
		}), g.SliceInt别名{1, 2, 3, 4})
	})
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建整数并从数组(g.SliceInt别名{1, 2, 3, 4})
		t.Assert(array.X遍历删除(func(index int, value int) bool {
			return empty.IsEmpty(value)
...
func TestIntArray_Walk(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建整数并从数组(g.SliceInt别名{1, 2})
