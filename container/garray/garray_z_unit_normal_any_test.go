...
func TestArray_PopLeft(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.NewFrom别名(g.Slice别名{1, 2, 3})
		v, ok := array.X出栈左()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestArray_FilterNil(t *testing.T) {
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建并从数组复制(g.Slice别名{nil, 1, 2, 3, 4, nil})
...
func TestArray_Filter(t *testing.T) {
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建并从数组(g.Slice别名{0, 1, 2, 3, 4, "", g.Slice别名{}})
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建并从数组(g.Slice别名{1, 2, 3, 4})
...
func TestArray_Walk(t *testing.T) {
	单元测试类.C(t, func(t *单元测试类.T) {
		array := 数组类.X创建并从数组(g.Slice别名{"1", "2"})
