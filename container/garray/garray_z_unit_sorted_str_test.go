...
func TestNewSortedStrArrayComparator(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := garray.X创建文本排序并带排序函数(func(a, b string) int {
			return gstr.X顺序比较(a, b)
		})
		s1.X入栈右(a1...)
		t.Assert(s1.X取长度(), 4)
...
func TestNewSortedStrArrayFrom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := garray.X创建文本排序并从切片(a1, true)
		t.Assert(s1, []string{"a", "b", "c", "d"})
		s2 := garray.X创建文本排序并从切片(a1, false)
...
func TestNewSortedStrArrayFromCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := garray.X创建文本排序并从切片复制(a1, true)
		t.Assert(s1.X取长度(), 4)
		t.Assert(s1, []string{"a", "b", "c", "d"})
	})
}
...
func TestSortedStrArray_PopLeft(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本排序并从切片(g.SliceStr别名{"1", "2", "3"})
		v, ok := array.X出栈左()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedStrArray_Range(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"e", "a", "d", "c", "b", "f", "g"}
		array1 := garray.X创建文本排序并从切片(a1)
		array2 := garray.X创建文本排序并从切片(a1, true)
...
func TestSortedStrArray_Rand(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array2 := garray.X创建文本排序并从切片([]string{})
		v, ok = array2.X取值随机()
		t.Assert(v, "")
		t.Assert(ok, false)
	})
...
func TestSortedStrArray_Join(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array1 := garray.X创建文本排序并从切片([]string{})
		t.Assert(array1.X连接("."), "")
	})
}
...
func TestSortedStrArray_Iterator(t *testing.T) {
	...
	array := garray.X创建文本排序并从切片(slice)
	gtest.C(t, func(t *gtest.T) {
...
func TestSortedStrArray_Filter(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本排序并从切片(g.SliceStr别名{"", "1", "2", "0"})
		t.Assert(array.X遍历删除(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), g.SliceStr别名{"0", "1", "2"})
	})
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本排序并从切片(g.SliceStr别名{"1", "2"})
		t.Assert(array.X遍历删除(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), g.SliceStr别名{"1", "2"})
	})
...
func TestSortedStrArray_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本排序并从切片([]string{"a", "b", "c", "d"})
