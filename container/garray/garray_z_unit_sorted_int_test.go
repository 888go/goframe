...
func TestNewSortedIntArrayComparator(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.X创建整数排序并带排序函数(func(a, b int) int {
			return a - b
		}, true)
		array1.Append别名(a1...)
		t.Assert(array1.X取长度(), 7)
		t.Assert(array1.X取any切片(), []int{0, 1, 2, 3, 4, 5, 6})
	})
}

func TestNewSortedIntArrayRange(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array1 := garray.X创建整数排序并按范围(1, 5, 1)
		t.Assert(array1.X取长度(), 5)
		t.Assert(array1.X取any切片(), []int{1, 2, 3, 4, 5})
	})
}
...
func TestNewSortedIntArrayFrom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []int{0, 3, 2, 1, 4, 5, 6}
		array1 := garray.X创建整数排序并从切片(a1, true)
		t.Assert(array1.X连接("."), "0.1.2.3.4.5.6")
		t.Assert(array1.X取切片(), a1)
		t.Assert(array1.X取any切片(), a1)
	})
}
...
func TestNewSortedIntArrayFromCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.X创建整数排序并从切片复制(a1, false)
		t.Assert(array1.X连接("."), "0.1.2.3.4.5.6")
	})
}
...
func TestSortedIntArray_PopLeft(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建整数排序并从切片(g.SliceInt别名{1, 2, 3})
		v, ok := array.X出栈左()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedIntArray_Range(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []int{1, 3, 5, 2, 6, 7}
		array1 := garray.X创建整数排序并从切片(a1)
		array2 := garray.X创建整数排序并从切片(a1, true)
...
func TestSortedIntArray_Iterator(t *testing.T) {
	...
	array := garray.X创建整数排序并从切片(slice)
	gtest.C(t, func(t *gtest.T) {
...
func TestSortedIntArray_Filter(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建整数排序并从切片(g.SliceInt别名{0, 1, 2, 3, 4, 0})
		t.Assert(array.X遍历删除(func(index int, value int) bool {
			return empty.IsEmpty(value)
		}), g.SliceInt别名{1, 2, 3, 4})
	})
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建整数排序并从切片(g.SliceInt别名{1, 2, 3, 4})
		t.Assert(array.X遍历删除(func(index int, value int) bool {
			return empty.IsEmpty(value)
		}), g.SliceInt别名{1, 2, 3, 4})
	})
...
func TestSortedIntArray_Walk(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建整数排序并从切片(g.SliceInt别名{1, 2})
...
func TestSortedIntArray_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建整数排序并从切片([]int{1, 2, 3, 4, 5})
