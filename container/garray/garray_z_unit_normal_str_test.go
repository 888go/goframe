...
func Test_StrArray_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array := garray.X创建文本并从切片(expect)
		array2 := garray.X创建文本并从切片(expect, true)
		array3 := garray.X创建文本并从切片([]string{})
	...
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本并从切片([]string{"0", "1", "2", "3"})
...
func TestStrArray_Unique(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.X创建文本并从切片([]string{})
...
func TestStrArray_PopLeft(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本并从切片(g.SliceStr别名{"1", "2", "3"})
		v, ok := array.X出栈左()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestStrArray_PopLeftsAndPopRights(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.X创建文本并从切片(value1)
		array2 := garray.X创建文本并从切片(value2)
...
func TestString_Range(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		value1 := []string{"0", "1", "2", "3", "4", "5", "6"}
		array1 := garray.X创建文本并从切片(value1)
		array2 := garray.X创建文本并从切片(value1, true)
...
func TestStrArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a11 := []string{"0", "1", "2", "3"}
		a21 := []string{"4", "5", "6", "7"}
		array1 := garray.X创建文本并从切片(a11)
		array2 := garray.X创建文本并从切片(a21)
...
func TestStrArray_Fill(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"0"}
		a2 := []string{"0"}
		array1 := garray.X创建文本并从切片(a1)
		array2 := garray.X创建文本并从切片(a2)
...
func TestStrArray_SubSlice(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.X创建文本并从切片(a1)
		array2 := garray.X创建文本并从切片(a1, true)
...
func TestStrArray_Rand(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array2 := garray.X创建文本并从切片([]string{})
		v, ok = array2.X取值随机()
		t.Assert(ok, false)
		t.Assert(v, "")
...
func TestNewStrArrayFromCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"0", "1", "2", "3", "4", "5", "6"}
		a2 := garray.X创建文本并从切片复制(a1)
		a3 := garray.X创建文本并从切片复制(a1, true)
...
func TestStrArray_Filter(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本并从切片(g.SliceStr别名{"", "1", "2", "0"})
		t.Assert(array.X遍历删除(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), g.SliceStr别名{"1", "2", "0"})
	})
	gtest.C(t, func(t *gtest.T) {
		array := garray.X创建文本并从切片(g.SliceStr别名{"1", "2"})
		t.Assert(array.X遍历删除(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), g.SliceStr别名{"1", "2"})
	})
