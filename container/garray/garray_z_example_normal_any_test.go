...
func ExampleArray_Iterator() {
	array := 数组类.X创建并从数组(g.Slice别名{"a", "b", "c"})
...
func ExampleArray_Reverse() {
	array := 数组类.NewFrom别名(g.Slice别名{1, 2, 3, 4, 5, 6, 7, 8, 9})
...
func ExampleArray_Join() {
	array := 数组类.NewFrom别名(g.Slice别名{"a", "b", "c", "d"})
...
func ExampleArray_Merge() {
	array1 := 数组类.NewFrom别名(g.Slice别名{1, 2})
	array2 := 数组类.NewFrom别名(g.Slice别名{3, 4})
...
func ExampleArray_Filter() {
	array1 := 数组类.NewFrom别名(g.Slice别名{0, 1, 2, nil, "", g.Slice别名{}, "john"})
	array2 := 数组类.NewFrom别名(g.Slice别名{0, 1, 2, nil, "", g.Slice别名{}, "john"})
