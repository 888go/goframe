...
// 翻译提示:func (l *列表) 在前面添加元素(v interface{})
...
// 翻译提示:func (l *列表) 在尾部添加(value interface{})
...
// 翻译提示:func (l *列表) 在前面添加(values ...interface{})
...
// 翻译提示:func (l *列表) 在后面添加元素(values ...interface{})
...
// 翻译提示:func (l *列表) 从尾部弹出() (元素 interface{})
...
// 翻译提示:func (l *列表) 弹出前端() (值 interface{})
...
// 翻译提示:func (l *列表) 弹出尾部元素(max int) (值 []interface{}) 
...
// 翻译提示:func (l *列表) 弹出前端(max int) (值 []interface{}) {
...
// 翻译提示:func (l *列表) 移除所有后部元素() []interface{}
...
// 翻译提示:func (l *列表) 移除所有前端元素() []interface{}
func (l *List) PopFrontAll() []interface{} {
	return l.PopFronts(-1)
}

// FrontAll 复制并返回列表 `l` 前端所有元素的值作为一个切片。. md5:93c8d4452c927952
// 翻译提示:func (l *列表) 获取所有前部元素() (元素列表 []interface{})
...
// 翻译提示:func (l *列表) 获取所有后部元素() (元素 []interface{})
...
// 翻译提示:func (l *列表) 首元素Value() (元素 interface{})
...
// 翻译提示:func (l *列表) 后面元素() (元素 interface{})
