...
# <翻译开始>
// To是一个链式函数，
// 它将当前日志内容输出重定向到指定的`writer`。 md5:198a22b4aa1923ef
# <翻译结束>
...
# <翻译开始>
// Path是一个链式函数，它为当前日志内容输出设置目录路径为`path`。 md5:9f023b954ca40c7e
# <翻译结束>
...
# <翻译开始>
// Cat 是一个链式函数，
// 用于将当前日志内容输出的类别设置为 `category`。 md5:9233c1ec32751e89
# <翻译结束>
...
# <翻译开始>
// File是一个链式函数，
// 用于设置当前日志内容输出的文件名`pattern`。 md5:2daa0ddd7ccf2b81
# <翻译结束>
...
# <翻译开始>
// Level是一个链式函数，它为当前日志输出内容设置日志级别。 md5:47d5e7fde254fd72
# <翻译结束>
...
# <翻译开始>
// LevelStr 是一个链式函数，
// 它使用级别字符串设置当前日志输出内容的记录级别。 md5:1edd3ebd98ec4de9
# <翻译结束>
...
// Skip 是一个链式函数，
// 用于设置当前日志内容输出的堆栈跳过级别。
// 当启用行号打印时，它也会影响调用者文件路径的检查。 md5:f009e835989b7d56
# <翻译结束>
...
# <翻译开始>
// Stack是一个链式函数，
// 用于设置当前日志内容输出的堆栈选项。 md5:aa980bb8d1f29075
# <翻译结束>
...
# <翻译开始>
// StackWithFilter是一个链式函数，它为当前日志内容输出设置堆栈过滤器。 md5:07c5327660880bce
# <翻译结束>
...
# <翻译开始>
// Stdout 是一个链式函数，
// 它允许/禁用当前日志内容输出到标准输出。默认启用。 md5:47b9f2393a7d5d1f
# <翻译结束>
...
// 默认情况下，它是启用的。 md5:0d1df22042835f38
# <翻译结束>
...
# <翻译开始>
// Async 是一个链式函数，
// 用于启用或禁用异步日志输出功能。 md5:8b08233b7c37c09f
# <翻译结束>
