...
// 开发者可以使用自定义的`writer`将日志输出重定向到其他服务，如：kafka、mysql、mongodb等。 md5:50799f5f4e6280ea
# <翻译结束>
...
// 如果没有设置自定义 writer，它将返回 nil。 md5:37b3d820b5547c91
# <翻译结束>
...
# <翻译开始>
// SetDebug 启用/禁用默认 defaultLogger 的调试级别。默认情况下，调试级别已启用。 md5:335740e0731656b1
# <翻译结束>
