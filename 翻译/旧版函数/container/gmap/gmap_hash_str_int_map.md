...
# <翻译开始>
) Search(key string) (value int, found
成功
# <翻译结束>
...
# <翻译开始>
) Diff(other *StrIntMap) (addedKeys, removedKeys, updatedKeys
更新数据的名称
# <翻译结束>

# <翻译开始>
) Diff(other *StrIntMap) (addedKeys, removedKeys
删除的名称
# <翻译结束>

# <翻译开始>
) Diff(other *StrIntMap) (addedKeys
增加的名称
# <翻译结束>
...
# <翻译开始>
func NewStrIntMapFrom(data map[string]int, safe
并发安全
# <翻译结束>

# <翻译开始>
func NewStrIntMapFrom(data
map值
# <翻译结束>
