...
func Test_Uint32(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		i := 安全变量类.NewUint32(0)
		iClone := i.Clone()
		t.AssertEQ(iClone.X设置值(1), uint32(0))
		t.AssertEQ(iClone.X取值(), uint32(1))
		...
		wg.Wait()
		t.AssertEQ(uint32(addTimes), i.X取值())

		// empty param test
		i1 := 安全变量类.NewUint32()
		t.AssertEQ(i1.X取值(), uint32(0))

		i2 := 安全变量类.NewUint32(11)
...
func Test_Uint32_JSON(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		i := 安全变量类.NewUint32(math.MaxUint32)
