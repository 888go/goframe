...
type Plugin interface {
	Name() string            // Name 返回插件的名称。. md5:2db3d61fbe59c133
	Author() string          // Author返回插件的作者。. md5:1b32b0dc8d2dde4d
	Version() string         // Version 返回插件的版本号，例如 "v1.0.0"。. md5:d00cdffa2274f882
	Description() string     // Description 返回插件的描述。. md5:b3440b3816c4f5af
