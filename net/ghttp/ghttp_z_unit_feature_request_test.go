...
func Test_Params_Basic(t *testing.T) {
	...
	// PUT
	s.X绑定("/put", func(r *ghttp.Request) {
	...
	// DELETE
	s.X绑定("/delete", func(r *ghttp.Request) {
		if r.Get别名("array") != nil {
			r.X响应.X写响应缓冲区(r.Get别名("array"))
		}
		if r.Get别名("slice") != nil {
	...
	// PATCH
	s.X绑定("/patch", func(r *ghttp.Request) {
		if r.Get别名("array") != nil {
			r.X响应.X写响应缓冲区(r.Get别名("array"))
		}
		if r.Get别名("slice") != nil {
	...
	// Form
	s.X绑定("/form", func(r *ghttp.Request) {
		if r.Get别名("array") != nil {
	...
	s.X绑定("/raw", func(r *ghttp.Request) {
	...
	s.X绑定("/struct", func(r *ghttp.Request) {
		if m := r.X取查询参数到Map(); len(m) > 0 {
			user := new(User)
			r.X取查询参数到结构体(user)
	...
	s.X绑定("/struct-with-nil", func(r *ghttp.Request) {
		user := (*User)(nil)
		err := r.GetStruct别名(&user)
		r.X响应.X写响应缓冲区(err)
	})
	s.X绑定("/struct-with-base", func(r *ghttp.Request) {
		type Base struct {
			Pass1 string `p:"password1"`
			Pass2 string `p:"password2"`
		}
...
func Test_Params_Header(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/header", func(r *ghttp.Request) {
...
func Test_Params_SupportChars(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/form-value", func(r *ghttp.Request) {
		r.X响应.X写响应缓冲区(r.X取表单值到泛型类("test-value"))
	})
	s.X绑定("/form-array", func(r *ghttp.Request) {
...
func Test_Params_Priority(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/query", func(r *ghttp.Request) {
		r.X响应.X写响应缓冲区(r.X取查询参数到泛型类("a"))
	})
	s.X绑定("/form", func(r *ghttp.Request) {
		r.X响应.X写响应缓冲区(r.X取表单值到泛型类("a"))
	})
	s.X绑定("/request", func(r *ghttp.Request) {
		r.X响应.X写响应缓冲区(r.Get别名("a"))
	})
	s.X绑定("/request-map", func(r *ghttp.Request) {
...
func Test_Params_GetRequestMap(t *testing.T) {
	...
	s.X绑定("/withKVMap", func(r *ghttp.Request) {
		m := r.X取参数到Map(map[string]interface{}{"id": 2})
		r.X响应.X写响应缓冲区(m["id"])
	})
	s.X绑定("/paramsMapWithKVMap", func(r *ghttp.Request) {
		r.X设置自定义参数("name", "john")
		m := r.X取参数到Map(map[string]interface{}{"id": 2})
		r.X响应.X写响应缓冲区(m["id"])
	})
	s.X绑定("/{name}.map", func(r *ghttp.Request) {
		m := r.X取参数到Map(map[string]interface{}{"id": 2})
		r.X响应.X写响应缓冲区(m["id"])
	})
	s.SetDumpRouterMap(false)
...
func Test_Params_Modify(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/param/modify", func(r *ghttp.Request) {
		param := r.GetMap别名()
		param["id"] = 2
		paramBytes, err := gjson.X变量到json字节集(param)
		if err != nil {
			r.X响应.X写响应缓冲区(err)
			return
		}
...
func Test_Params_SetQuery(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/SetQuery", func(r *ghttp.Request) {
		r.X设置查询参数("a", 100)
		r.X响应.X写响应缓冲区(r.X取查询参数到泛型类("a"))
	})
	s.SetDumpRouterMap(false)
...
func Test_Params_GetQuery(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetQuery", func(r *ghttp.Request) {
...
func Test_Params_GetQueryMap(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetQueryMap", func(r *ghttp.Request) {
		if m := r.X取查询参数到Map(); len(m) > 0 {
			r.X响应.X写响应缓冲区(m["name"])
		}
	})
	s.X绑定("/GetQueryMapWithKVMap", func(r *ghttp.Request) {
...
func Test_Params_GetQueryMapStrStr(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetQueryMapStrStr", func(r *ghttp.Request) {
...
func Test_Params_GetQueryMapStrVar(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetQueryMapStrVar", func(r *ghttp.Request) {
		m := r.X取查询参数到Map泛型类切片()
		r.X响应.X写响应缓冲区(m["id"])
	})
	s.SetDumpRouterMap(false)
...
func Test_Params_GetRequest(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetRequest", func(r *ghttp.Request) {
		r.X响应.X写响应缓冲区(r.X取参数("id"))
	})
	s.X绑定("/GetRequestWithDef", func(r *ghttp.Request) {
...
func Test_Params_GetRequestMapStrStr(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetRequestMapStrStr", func(r *ghttp.Request) {
...
func Test_Params_GetRequestMapStrVar(t *testing.T) {
	s := g.Http类(guid.X生成())
	s.X绑定("/GetRequestMapStrVar", func(r *ghttp.Request) {
		m := r.X取参数到Map泛型类()
		r.X响应.X写响应缓冲区(m["id"])
	})
	s.SetDumpRouterMap(false)
