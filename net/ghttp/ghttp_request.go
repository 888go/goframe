...
//
// 警告：将来将被移除，请使用第三方WebSocket库代替。 md5:68ad17d4740330b2
...
// 注意，此IP地址可能已被客户端头部信息修改。 md5:54dc4a1d4744646a
...
// GetError 返回请求过程中发生的错误。如果没有错误，它将返回 nil。 md5:035e49a2662f9c04
...
// 因此它会清除 Request 的已解析标记，使得参数能够被重新解析。 md5:af7ff26c797683ef
