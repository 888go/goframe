...
func Test_RandStr(t *testing.T) {
	...
	单元测试类.C(t, func(t *单元测试类.T) {
		for i := 0; i < 10; i++ {
			...
			t.Assert(文本类.X是否包含(s, "我"), true)
			t.Assert(文本类.X是否包含(s, "爱"), true)
			t.Assert(文本类.X是否包含(s, "G"), true)
			t.Assert(文本类.X是否包含(s, "o"), true)
			t.Assert(文本类.X是否包含(s, "F"), true)
			t.Assert(文本类.X是否包含(s, "r"), true)
			t.Assert(文本类.X是否包含(s, "a"), true)
			t.Assert(文本类.X是否包含(s, "m"), true)
			t.Assert(文本类.X是否包含(s, "e"), true)
			t.Assert(文本类.X是否包含(s, "w"), false)
		}
	})
	单元测试类.C(t, func(t *单元测试类.T) {
